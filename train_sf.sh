CUDA_VISIBLE_DEVICES=0 python3 train.py --batch_size=4 \
                ...
                --net_arch_fea='./run/sceneflow/feature_network_path.npy' \
                --cell_arch_fea='run/sceneflow/feature_genotype.npy' \
                --net_arch_mat='run/sceneflow/matching_network_path.npy' \
                --cell_arch_mat='run/sceneflow/matching_genotype.npy' \
